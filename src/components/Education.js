        ...
        <div class='information'>
          <div>
            ...
            <h3>
              <ul>
                <li>
                  Chosen to attend the prestigious LATAM Impact Program in 2019
                  which selects only 10 individuals from the world's top
                  schools.
                </li>
          ...
          <div>
            ...
            <h3>
              <ul>
                ...
                <li>
                  Outstanding Cambridge Learners Award (Additional Mathematics)
                </li>
